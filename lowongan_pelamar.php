    ...
    <div id="loginModal" class="modal">
        <div class="modal-content">
            ...
            <div style="display: flex; flex-direction: column; gap: 12px; align-items: center; width: 100%;">
                ...
                <!-- TOMBOL GOOGLE MANUAL (PASTIKAN SELALU MUNCUL DAN ANTI-GAGAL) -->
                <a href="auth-google.php?lowongan_id=<?php echo $selected_id; ?>" class="btn-google" style="text-decoration: none; width: 100%; display: flex; justify-content: center; align-items: center;">
                ...
                <!-- TOMBOL APPLE -->
                <button onclick="alert('Fitur Apple Sign-In memerlukan Apple Developer Account')" class="btn-apple" style="width: 100%;">
                    <svg viewBox="0 0 24 24" width="16" height="16" fill="white" xmlns="http://w3.org" style="display: inline-block; vertical-align: middle; margin-right: 8px;">
