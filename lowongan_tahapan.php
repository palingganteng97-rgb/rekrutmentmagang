...
<a href="jadwal_seleksi.php?lowongan_id=<?= $id_lowongan; ?>&tahapan_id=<?= $id_tahapan; ?>" class="btn-action btn-schedule" title="Jadwal Seleksi" style="display: inline-flex; align-items: center; justify-content: center; width: 32px; height: 32px; background-color: #dbeafe; border-radius: 6px; text-decoration: none;">    <svg xmlns="http://w3.org" width="16" height="16" fill="#1d4ed8" viewBox="0 0 16 16">
